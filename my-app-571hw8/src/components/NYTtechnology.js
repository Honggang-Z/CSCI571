...
class NYTtechnology extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            response: {}
    ...
    componentDidMount() {
        axios.get('http://ec2-54-205-64-116.compute-1.amazonaws.com:3030/nytimes/technology')
            .then(res => {
